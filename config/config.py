...
BOT_TOKEN = getenv("BOT_TOKEN", "6273670168:AAHWUly9raKalgJA7mtRvh4TizYFUXn06rI")
...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Bila")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5999080636").split())
)  # Input type must be interger

# Get it from http://dashboard.heroku.com/account
HEROKU_API_KEY = getenv("HEROKU_API_KEY", "e282961d-39d1-450d-ad90-3fbf7d0161b7")
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/SourceBila"
)  # Example:- https://t.me/SourceBila
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/SourceBila"
)  # Example:- https://t.me/SourceBila
