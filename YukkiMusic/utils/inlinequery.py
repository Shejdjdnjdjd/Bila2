...
answer.extend(
    [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent("بيلا طفيها"),
        ),
        InlineQueryResultArticle(
            title="تكرار التشغيل",
