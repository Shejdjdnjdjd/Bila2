        ...
        buttons.append(
            [
                ...
                InlineKeyboardButton(
                    ...
                    text=_["S_B_9"], url=f"https://t.me/SourceBila"
    ...
    if GITHUB_REPO and OWNER:
        ...
        if OWNER:
            buttons.append(
                [
                    InlineKeyboardButton(
                        text=_["S_B_11"], url=f"https://t.me/SourceBila"
                    ),
                    InlineKeyboardButton(

                        text=_["S_B_12"], url=f"https://t.me/O_4_Q"
            ...
            buttons.append(
                [
                    ...
                    InlineKeyboardButton(
                        ...
                        text=_["S_B_10"], url=f"https://t.me/SourceBila"
...
3 • لو تبي تشوف الاوامر اكتب [ م الاوامر ] ولو تبي تشغل على طول اكتب بيلا شغلي + اسم المقطع الصوتي

• مثال : بيلا شغلي واتنسيت

- لو واجهت مشكله او ما فهمت خطوة كلم مطور البوت ~ @R_c_B""",
