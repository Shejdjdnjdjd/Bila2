...
async def am(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           "https://telegra.ph/file/60ff97e27851e8cb98871.mp4",None,
           "**✧ اهلين فيك في اوامر بوت بيلا**\n\n- عندك خمس ازرار وبعدها بتعرف تستخدم البوت ان شاء الله\n\n• مطور البوت -› @R_c_B\n• قناة البوت -› @SourceBila"
       ),
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
async def sound(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaPhoto(
           "https://telegra.ph/file/52d9b164b4254e0175e27.jpg",
...
async def sound(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaPhoto(
           ...
           "✧ **اهلين فيك في قسم الاوامر الخدمية**\n-** عندك اوامر كثيرة للتسلية ومنها ↓**\n\n-› **غنيلي\n-› افتارات بنات\n-› افتارات عيال\n-› افتارات مكس\n -› هيدرات او هيدر\n-› اقتباس او اقتباسات\n-› كت**\n\n✶ **ايضا تقدر تتابع قناة بيلا فيها تشكلية كبيرة من كل الي ذكرتهم فوق**\n-› @O_4_Q"
      ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
                     ...
                     InlineKeyboardButton(
                        "• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝑩𝒊𝒍𝒂 •", url=f"t.me/O_4_Q")
